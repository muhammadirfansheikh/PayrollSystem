<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Designation.aspx.cs" MasterPageFile="~/MasterPage/AdminMaster.master" Inherits="Pages_HRMS_Setup_Designation" %>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group col-lg-3">
                                    ...
                                    <asp:DropDownList ID="ddlJobCategorySearch" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
                                </div>
                                <div class="form-group col-lg-3">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="ddlCategoryAdd" InitialValue="0"></asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="ddlCategoryAdd" InitialValue=""></asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlCategoryAdd" runat="server" CssClass="form-control ddlCategoryAdd">
                                        </asp:DropDownList>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <asp:TextBox runat="server" placeholder="Designation" ID="txtNameAdd" class="form-control txtAdd" />
                                    </div>
                                </div>
                            </div>
