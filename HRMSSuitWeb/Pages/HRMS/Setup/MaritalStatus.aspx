<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="MaritalStatus.aspx.cs" Inherits="Pages_HRMS_Setup_MaritalStatus" %>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-3">
                                <label for="exampleInputEmail2">Marital Status</label>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <label class="col-lg-12">Marital Status:<em>*</em></label>
                                        <asp:TextBox runat="server" placeholder="Marital Status Name" ID="txtMaritalStatusNameAdd" class="form-control txtAdd" />
                                        <span class="help-block m-b-none"></span>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Add"
                                            Display="Dynamic" ControlToValidate="txtMaritalStatusNameAdd" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                    </div>
