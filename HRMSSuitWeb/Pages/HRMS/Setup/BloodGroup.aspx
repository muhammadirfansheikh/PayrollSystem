<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="BloodGroup.aspx.cs" Inherits="Pages_HRMS_Setup_BloodGroup" %>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <label class="col-lg-12">Blood Group:<em>*</em></label>
                                                <asp:TextBox runat="server" placeholder="Blood Group Name" ID="txtBloodGroupNameAdd" class="form-control txtAdd" />
                                                <span class="help-block m-b-none"></span>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Add"
                                                    Display="Dynamic" ControlToValidate="txtBloodGroupNameAdd" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                            </div>
