<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Company.aspx.cs" MasterPageFile="~/MasterPage/AdminMaster.master" Inherits="Pages_HRMS_Setup_Company" %>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                              <div class="form-group col-lg-3">
                                ...
                                <asp:DropDownList ID="ddlgroupSearch" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group col-lg-3">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="Add" Text="*" ErrorMessage="Group" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="ddlGroupAdd" InitialValue="0"></asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Add" Text="*" ErrorMessage="Group" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="ddlGroupAdd" InitialValue=""></asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlGroupAdd" runat="server" CssClass="form-control ddlGroupAdd">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-lg-12">
                                        <label for="exampleInputPassword2">Company</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="Add" Text="*" ErrorMessage="Company" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="txtNameAdd"></asp:RequiredFieldValidator>
                                        <asp:TextBox runat="server" MaxLength="50" placeholder="Company" ID="txtNameAdd" class="form-control txtAdd" />
                                    </div>
