<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Gender.aspx.cs" Inherits="Pages_HRMS_Setup_Gender" %>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <label class="col-lg-12">Gender Name:<em>*</em></label>
                                        <asp:TextBox runat="server" placeholder="Gender Name" ID="txtGenderNameAdd" class="form-control txtAdd" />
                                        <span class="help-block m-b-none"></span>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Add"
                                            Display="Dynamic" ControlToValidate="txtGenderNameAdd" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                    </div>
