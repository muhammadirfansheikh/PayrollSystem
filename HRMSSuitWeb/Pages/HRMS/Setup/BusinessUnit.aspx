<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="BusinessUnit.aspx.cs" Inherits="Pages_HRMS_Setup_BusinessUnit" %>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add / Edit Business Unit</h4>
                </div>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <asp:TextBox runat="server" placeholder="Business Unit" ID="txtNameAdd" class="form-control txtAdd" />
                                    </div>
