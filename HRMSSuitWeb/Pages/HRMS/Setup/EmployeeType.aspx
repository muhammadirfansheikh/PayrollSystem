<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/AdminMaster.master" CodeFile="EmployeeType.aspx.cs" Inherits="Pages_HRMS_Setup_EmployeeType" %>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        <label class="col-lg-12">Employee Type:<em>*</em></label>
                                        <asp:TextBox runat="server" placeholder="Education Status Title" ID="txtNameAdd" class="form-control txtAdd" />
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <asp:DropDownList ID="ddlCompanyAdd" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
