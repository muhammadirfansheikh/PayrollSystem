<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HiringType.aspx.cs" MasterPageFile="~/MasterPage/AdminMaster.master" Inherits="Pages_HRMS_Setup_HiringType" %>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-3">
                                <label for="exampleInputEmail2">Hiring Type</label>
                        ...
                        <div class="ibox-tools">
                            ...
                            <div class="ibox-content">
                                <div class="row m-b-sm m-t-sm">
                                    <div class="col-md-12">
                                        <div class="panel-heading">
                                            <a href="#" class="btn btn-primary btnAdd pull-right">Add new Hiring Type</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="padding-bottom: 9px; padding-top: 9px;">
                    ...
                    <h4 class="modal-title">Add New Hiring Type</h4>
                    <%--<small class="font-bold">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</small>--%>
                </div>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div class="modal-body" style="padding-bottom: 10px; border-bottom-width: 10px; padding-top: 10px; height: 127px;">
                            ...
                            <div class="form-group">
                                <label class="col-lg-12">Hiring Type:<em>*</em></label>
                                <div class="col-lg-12">
                                    <asp:TextBox runat="server" placeholder="Hiring Type" ID="txtNameAdd" class="form-control txtAdd" />
