<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/AdminMaster.master" CodeFile="EmployeeCompanyMapping.aspx.cs" Inherits="Pages_HRMS_Setup_EmployeeCompanyMapping" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Employee Company Mapping</h2>
            <ol class="breadcrumb">
                  <li>
                    <a href="#">General Setup</a>
                </li>
                <li class="active">
                    <strong>Employee Company Mapping</strong>
                </li>
            </ol>
        </div>
    </div>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        <td class="project-title">
                                                            ...
                                                            <input type="hidden" runat="server" id="hfId" class="hfId" value='<%# Eval("EmployeeID") %>' />
                                                        </td>
                                                        <td class="project-title">
        ...
        <div class="modal-dialog">
            <div class="modal-content animated flipInY">
                <div class="modal-header" style="padding-bottom: 9px; padding-top: 9px;">
                    ...
                    <h4 class="modal-title">Assign Company to Employee</h4>
                    ...
                    <ContentTemplate>
                        <div class="modal-body" style="padding-bottom: 10px; border-bottom-width: 10px; padding-top: 10px; height: 411px;">
                           ...
                           <%-- <div class="form-group">
                            ...
                            <div class="form-group col-lg-12">
                                <label for="exampleInputPassword2">Company</label>
                                <asp:CheckBoxList CssClass="cblCheckAll" CellSpacing="100" ID="cbCompanyAdd" RepeatDirection="Horizontal" runat="server">
                                </asp:CheckBoxList>
                            </div>
                            <div class="form-group col-lg-12">
                                <asp:Button Text="Save" class="btn btn-primary pull-right" ID="btnAdd" ValidationGroup="Add" OnClick="btnAdd_Click" runat="server" />
                            </div>
                        </div>
