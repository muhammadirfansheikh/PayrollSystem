<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CostCenter.aspx.cs" MasterPageFile="~/MasterPage/AdminMaster.master" Inherits="Pages_HRMS_Setup_CostCenter" %>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <asp:TextBox ID="txtCostCenterCodeSearch" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group col-lg-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add / Edit Cost Center</h4>
                </div>
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <asp:TextBox runat="server" placeholder="Cost Center" ID="txtNameAdd" class="form-control txtAdd" />
                                    </div>


                                    <div class="col-lg-12">
                                        <label for="exampleInputPassword2">Code</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="txtCostCenterCode" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                        <asp:TextBox runat="server" placeholder="Code" ID="txtCostCenterCode" class="form-control txtCostCenterCode" />
                                    </div>
