<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Religion.aspx.cs" MasterPageFile="~/MasterPage/AdminMaster.master" Inherits="Pages_HRMS_Setup_Religion" %>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-3">
                                <label for="exampleInputEmail2">Religion</label>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-lg-12">Religion:<em>*</em></label>

                                    <div class="col-lg-12">
                                        <asp:TextBox runat="server" placeholder="Religion" ID="txtNameAdd" class="form-control txtAdd" />
