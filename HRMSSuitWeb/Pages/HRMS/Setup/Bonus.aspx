<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Bonus.aspx.cs" Inherits="Pages_HRMS_Setup_Bonus" %>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <asp:DropDownList ID="ddlBonus" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                            </div>
                    ...
                    <div class="wrapper wrapper-content animated fadeInUp">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <asp:HiddenField runat="server" ID="HFbonusid" />
                                <asp:HiddenField runat="server" ID="HFcompanyformulaid" />
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td class="project-title">
                                                            <%# Eval("AllowanceName") %>
                                                             <input type="hidden" runat="server" id="hfCompanyId" value='<%# Eval("CompanyID") %>' />
                                                        </td>
                                                        <td class="project-title">
                                                            <%# Convert.ToDateTime(Eval("MaxJoining")).ToString("yyyy-MM-dd") %>
                                                            <input type="hidden" runat="server" id="hfBonusId" value='<%# Eval("BonusId") %>' />
                                                            <input type="hidden" runat="server" id="hfCompanyFormulaId" value='<%# Eval("CompanyFormulaId") %>' />
                                                        </td>
                                                        <td class="project-title">
                                                            <%# Convert.ToDateTime(Eval("BonusDate")).ToString("yyyy-MM-dd") %>
                                                        </td>
                                                        <td class="project-title">
                                                            <%# Convert.ToDateTime(Eval("ReleaseDate")).ToString("yyyy-MM-dd") %>
                                                        </td>
                                                        <td class="project-title">
                                                            <%# Eval("YearFrom") %>
                                                        </td>
                                                        <td class="project-title">
                                                            <p title="<%# Eval("IsRelease") %>" onclick="checkrpt('<%# Eval("IsRelease") %>')"><%# Eval("IsRelease") %></p>
                                                            <asp:HiddenField runat="server" ID="hfIsRelease" Value='<%# Eval("IsRelease") %>' />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add / Edit Bonus</h4>
                </div>
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <label for="exampleInputPassword2">Bonus</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="ddlBonusAdd" InitialValue="0"></asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="ddlBonusAdd" InitialValue=""></asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlBonusAdd" runat="server" CssClass="form-control ddlBonusAdd">
                                        </asp:DropDownList>
                                    </div>

                                    <div class="col-lg-4">
                                        <label for="exampleInputPassword2">Max Joining Date</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="txtMaxJoiningDate" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtMaxJoiningDate" runat="server" CssClass="form-control datetime" AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>

                                    <div class="col-lg-4">
                                        <label for="exampleInputPassword2">Bonus Date</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="txtBonusDate" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtBonusDate" runat="server" CssClass="form-control datetime" AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>

                                    <div class="col-lg-4">
                                        <label for="exampleInputPassword2">Release Date</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="txtReleaseDate" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtReleaseDate" runat="server" CssClass="form-control datetime" AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>

                                    <div class="col-lg-4">
                                        <label for="exampleInputPassword2">Year</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="txtReleaseDate" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="ddlYearAdd" runat="server" CssClass="form-control ddlYearAdd">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer" runat="server" id="Div_Save">
                            <asp:Button Text="Save" class="btn btn-primary" ID="btnAdd" ValidationGroup="Add" OnClick="btnSave_Click" runat="server" />
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </div>
