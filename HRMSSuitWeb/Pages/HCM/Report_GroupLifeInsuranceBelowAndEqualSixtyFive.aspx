<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_GroupLifeInsuranceBelowAndEqualSixtyFive.aspx.cs" Inherits="Pages_HCM_Report_GroupLifeInsuranceBelowAndEqualSixtyFive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>
                <asp:Label runat="server" ID="lbl1" Text="Group Life Insurance Below And Equal Sixty Five" />
            </h2>
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>
                        <asp:Label runat="server" ID="lbl2" Text="Group Life Insurance Type 1" />
                    </strong>
                </li>
            </ol>
        </div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6 div_reportbutton" style="margin-top: 23px; display: none;">
                <input type="button" class="btn btn-info pull-right" value="Export" onclick="excelExportWithFileSaver('tableGLIBelowListing','Group_Life_Insurance_Type_1')" />
                <input type="button" class="btn btn-primary pull-right m-r-sm" value="Print" onclick="sendPrint('.tableGLIBelowListing')" />
            </div>
        </div>
    </div>
    <div class="panel panel-info">
        <div class="panel-heading">
            Group Life Insurance Below And Equal To Sixty Five
        </div>
        <div class="panel-body" style="overflow-x: scroll">
            <table class="table table-hover tableGLIBelowListing" id="tableGLIBelowListing">
                <thead class="theadGLIBelowlisting">
                ...
                <tbody class="tbodyGLIBelowListing">
                </tbody>
                <tfoot>
                    <tr class="info">
    ...
    <script type="text/x-jQuery-tmpl" id="GLIBelowListing">
        <tr class="trList">
    ...
    <script src="../../js/Page_JS/Report_GroupLifInsuraneBelowAndEqualSixtyFive.js"></script>
</asp:Content>
