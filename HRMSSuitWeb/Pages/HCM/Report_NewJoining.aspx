<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_NewJoining.aspx.cs" Inherits="Pages_HCM_Report_NewJoining" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>
                <asp:Label runat="server" ID="lbl1" Text="New Joining" />
            </h2>
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>
                        <asp:Label runat="server" ID="lbl2" Text="New Joining" />
                    </strong>
                </li>
            </ol>
        </div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-8 div_reportbutton" style="margin-top: 23px; display: none;">
                <input type="button" class="btn btn-info pull-right" value="Export" onclick="excelExportWithFileSaver('tableNewJoiningListing','New_Joining')" />
                <input type="button" class="btn btn-primary pull-right m-r-sm" value="Print" onclick="sendPrint('.tableNewJoiningListing')" />
            </div>
        </div>
    </div>
    <div class="panel panel-info">
        ...
        <div class="panel-body" style="overflow-x: scroll">
            <table class="table table-hover tableNewJoiningListing auto-index" id="tableNewJoiningListing">
                <thead class="theadNewJoininglisting">
                ...
                <tbody class="tbodyNewJoiningListing">
                </tbody>
                <tfoot>
                    <tr class="info">
    ...
    <script type="text/x-jQuery-tmpl" id="NewJoiningListing">
        <tr class="trList">
    ...
    <script src="../../js/Page_JS/Report_NewJoining.js"></script>
</asp:Content>
