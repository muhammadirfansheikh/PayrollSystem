<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_PayData.aspx.cs" Inherits="Pages_HCM_Report_PayData" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>
                <asp:Label runat="server" ID="lbl1" Text="Pay Data" />
            </h2>
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>
                        <asp:Label runat="server" ID="lbl2" Text="Pay Data" />
                    </strong>
                </li>
            </ol>
        </div>
        ...
        <div class="panel-body">
            <div class="col-lg-2 divMonthPayroll">
             ...
             <div class="col-lg-10 div_reportbutton" style="margin-top: 23px; display: none;">
                <input type="button" class="btn btn-info pull-right" value="Export" onclick="excelExportWithFileSaver('tablePayData','Pay_Data_Report')" />
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body" style="overflow-x: scroll">
            <table class="table table-hover tablePayData" id="tablePayData">
    ...
    <script src="../../js/Page_JS/Report_PayData.js"></script>
