<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_BudgetDetailActual.aspx.cs" Inherits="Pages_HCM_Report_BudgetDetailActual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>
                <asp:Label runat="server" ID="lbl1" Text="Budget Detail Report Actual" />
            </h2>
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>
                        <asp:Label runat="server" ID="lbl2" Text="Budget Detail Actual" />
                    </strong>
                </li>
            </ol>
        </div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6 div_reportbutton" style="margin-top: 23px; display: none;">
                <input type="button" class="btn btn-info pull-right" value="Export" onclick="excelExportWithFileSaver('tablebudgetdetailListing','Budget_Detail_Actual')" />
                <input type="button" class="btn btn-primary pull-right m-r-sm" value="Print" onclick="sendPrint('.tablebudgetdetailListing')" />
            </div>
        </div>
    </div>
    <div class="panel panel-info">
        <div class="panel-heading">
            Budget Detail Report Actual
        </div>
        <div class="panel-body" style="overflow-x: scroll">
            <table class="table table-hover tablebudgetdetailListing" id="tablebudgetdetailListing">
                <thead class="theadbudgetdetaillisting">
                ...
                <tbody class="tbodybudgetactualListing">
                </tbody>
                <tfoot>
                    <tr class="info">
    ...
    <script type="text/x-jQuery-tmpl" id="budgetactualListing">
        <tr class="trList">
    ...
    <script src="../../js/Page_JS/Report_BudgetActual.js"></script>
</asp:Content>
