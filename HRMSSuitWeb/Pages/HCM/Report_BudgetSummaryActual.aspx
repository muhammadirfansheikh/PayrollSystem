<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_BudgetSummaryActual.aspx.cs" Inherits="Pages_HCM_Report_BudgetSummaryActual" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>
                <asp:Label runat="server" ID="lbl1" Text="Budget Summary Report Actual" />
            </h2>
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>
                        <asp:Label runat="server" ID="lbl2" Text="Budget Summary" />
                    </strong>
                </li>
            </ol>
        </div>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6 pull-right div_reportbutton" style="margin-top: 23px; display: none;">
                <input type="button" class="btn btn-info pull-right" value="Export" onclick="excelExportWithFileSaver('tablebudgetsummaryactualListing','Budget_Summary_Report_Actual')" />
                <input type="button" class="btn btn-primary pull-right m-r-sm" value="Print" onclick="sendPrint('.tablebudgetsummaryactualListing')" />
            </div>
        </div>
    </div>
    <div class="panel panel-info">
        <div class="panel-heading">
            Budget Summary Report Actual
        </div>
        <div class="panel-body" style="overflow-x: scroll">
            <table class="table table-hover tablebudgetsummaryactualListing" id="tablebudgetsummaryactualListing">
                <thead class="theadbudgetsummaryactuallisting">
                ...
                <tbody class="tbodybudgetsummaryactualListing">
                </tbody>
                <tfoot>
                    <tr class="info">
    ...
    <script type="text/x-jQuery-tmpl" id="budgetsummaryactualListing">
        <tr class="trList">
            <td class="project-title"></td>
            <input class="DepartmentCode" type="hidden" value="${DepartmentCode}" />
            <input class="clsDepartment" type="hidden" value="${clsDepartment}" />
            <input class="LocationCode" type="hidden" value="${LocationCode}" />
            <input class="clsLocation" type="hidden" value="${clsLocation}" />
            <input class="CostCenterCode" type="hidden" value="${CostCenterCode}" />
            <input class="clsCostCenter" type="hidden" value="${clsCostCenter}" />
            <input class="SapCostCenterCode" type="hidden" value="${SapCostCenterCode}" />
    ...
    <script src="../../js/Page_JS/Report_BudgetSummaryActual.js"></script>
</asp:Content>
