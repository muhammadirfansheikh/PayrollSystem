<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SetupTax.aspx.cs" Inherits="Pages_HCM_Setup_SetupTax" %>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-3">
                                <label for="exampleInputEmail2">Tax</label>
                    ...
                    <ContentTemplate>
                        <div class="modal-body" style="padding-bottom: 10px; border-bottom-width: 10px; padding-top: 10px; height: 197px;">
                            ...
                            <div class="form-group">
                                <label class="col-lg-12">Tax:<em>*</em></label>
                                <div class="col-lg-6">
                                    <asp:TextBox runat="server" placeholder="Tax" ID="txtNameAdd" class="form-control txtAdd" />
