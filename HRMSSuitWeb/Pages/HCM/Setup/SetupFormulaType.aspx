<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SetupFormulaType.aspx.cs" Inherits="Pages_HCM_Setup_SetupFormulaType" %>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated flipInY">
                <div class="modal-header" style="padding-bottom: 9px; padding-top: 9px;">
                    ...
                    <h4 class="modal-title">Add New Formula Type</h4>
                    ...
                    <ContentTemplate>
                        <div class="modal-body" style="padding-bottom: 10px; border-bottom-width: 10px; padding-top: 10px; height: 197px;">
                            ...
                            <div class="form-group">
                                <label class="col-lg-12">Formula Type:<em>*</em></label>
                                <div class="col-lg-6">
                                    <asp:TextBox runat="server" placeholder="Formula Type" ID="txtNameAdd" class="form-control txtAdd" />
