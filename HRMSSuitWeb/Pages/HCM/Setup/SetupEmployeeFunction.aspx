<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SetupEmployeeFunction.aspx.cs" Inherits="Pages_HCM_Setup_SetupEmployeeFunction" %>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-lg-2 divMonthPayroll">
                                ...
                                <asp:TextBox ID="txtFunctionCode" runat="server" class="form-control" autocomplete="off"></asp:TextBox>

                            </div>
                            <div class="col-lg-2 divMonthPayroll">
                                <label>Function</label>

                                <asp:TextBox ID="txtFunctionName" runat="server" class="form-control" autocomplete="off"></asp:TextBox>
                                    ...
                                    <asp:GridView ID="rpt" runat="server" AllowPaging="true" PageSize="10" OnPageIndexChanging="rpt_PageIndexChanging" class="table table-striped table-bordered table-hover table-responsive" OnRowCommand="rpt_RowCommand" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:Button ID="lbEdit" runat="server" CssClass="btn btn-primary editopenmodal" CommandName="EditS" CommandArgument='<%# Eval("EmployeeFunctionId") %>' Text="Edit" />

                                                    <asp:Button ID="lbDelete" runat="server" CssClass="btn btn-danger" CommandName="DeleteS" OnClientClick="return confirm('Are you sure you wants to delete?')" CommandArgument='<%# Eval("EmployeeFunctionId") %>' Text="Delete" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Add / Edit Employee Function </h4>
                        </div>
                        ...
                        <div class="modal-body">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <label for="exampleInputPassword2">Function Code</label>

                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="txtEmployeeFunctionCodeAdd" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                        <asp:TextBox runat="server" ID="txtEmployeeFunctionCodeAdd" onkeypress="ForceNumericInput(this,0,false)" class="form-control numeric" placeholder="Function Code" />

                                    </div>
                                    <div class="col-lg-6">
                                        <label for="exampleInputPassword2">Function Name</label>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="Add" Text="*" ForeColor="Red"
                                            Display="Dynamic" ControlToValidate="txtFunctionNameAdd" CssClass="rfvbankdescription"></asp:RequiredFieldValidator>
                                        <asp:TextBox ID="txtFunctionNameAdd" runat="server" class="form-control " autocomplete="off"></asp:TextBox>
