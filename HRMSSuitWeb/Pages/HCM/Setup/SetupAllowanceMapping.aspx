<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SetupAllowanceMapping.aspx.cs" Inherits="Pages_HCM_Setup_SetupAllowanceMapping" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <uc:EmployeeSearchFilters runat="server" ID="EmployeeSearchFilters2" EmployeeCode="1" />
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row m-b-sm m-t-sm">
                            <div class="col-md-12">
                                <input type="button" data-toggle="modal" data-target="#MultiEmpMapAllowanceModal" value="Multi Allowance Mapping" class="btn btn-primary pull-right " onclick="OpenPopupMulti();" />
                            </div>
                        </div>
        ...
        <div class="modal-dialog" style="width: 50%;">
            <div class="modal-content animated fadeIn">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Allowance Mapping</h4>
                </div>
            </div>
        ...
        <div class="modal-dialog" style="width: 99%;">
            <div class="modal-content animated fadeIn">
                ...
                <div class="modal-footer">
                    ...
                    <input type="button" onclick="if(confirm('Are you sure you wants to delete?')){RemoveMultipleAllowances()};" class="btn btn-success " value="Remove Allowances" />
    ...
    <script src="../../../js/Page_JS/SetupAllowanceMapping.js"></script>
