<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="SetupAllowanceDeduction.aspx.cs" Inherits="Pages_HCM_Setup_SetupAllowanceDeduction" %>
                    ...
                    <ContentTemplate>
                        <div class="modal-body" style="padding-bottom: 10px; border-bottom-width: 10px; padding-top: 10px; height: 197px;">
                            ...
                            <div class="form-group">
                                <label class="col-lg-12">Allowance / Deduction:<em>*</em></label>
                                <div class="col-lg-6">
                                    <asp:TextBox runat="server" placeholder="Allowance / Deduction" ID="txtNameAdd" class="form-control txtAdd" />
                                 ...
                                 <div class="col-lg-6">
                                      <asp:CheckBox ID="chkIsDeduction" runat ="server" Text=" Deduction" />
                                     </div>
                            </div>
