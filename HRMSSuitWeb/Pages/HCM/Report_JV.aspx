<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="Report_JV.aspx.cs" Inherits="Pages_HCM_Report_JV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
     <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>
                <asp:Label runat="server" ID="lbl1" Text="JV" />
            </h2>
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>
                        <asp:Label runat="server" ID="lbl2" Text="JV" />
                    </strong>
                </li>
            </ol>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-2 divSummaryJV" style="margin-top: 28px;">
                <div class="checkbox checkbox-primary checkbox-inline">
                    ...
                    <label for="chkSummary">JV Summary</label>
                </div>
            </div>

            <div class="col-lg-8 div_reportbutton" style="margin-top: 23px; display: none;">
                <input type="button" class="btn btn-info pull-right" value="Export" onclick="excelExportWithFileSaver('tableJV','JV_Report')" />
    ...
    <script src="../../js/Page_JS/Report_JV.js"></script>
