<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMaster.master" AutoEventWireup="true" CodeFile="ReportIncrementLetter.aspx.cs" Inherits="Pages_HCM_ReportIncrementLetter" %>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-3">
                                    <label>Reporting Cost Center</label>
                                  <%--  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ValidationGroup="Search" Text="*" ForeColor="Red" Display="Dynamic" ControlToValidate="ddlReportingCostCenter" InitialValue="0"></asp:RequiredFieldValidator>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="Search" Text="*" ForeColor="Red" Display="Dynamic" ControlToValidate="ddlReportingCostCenter" InitialValue=""></asp:RequiredFieldValidator>--%>
                                ...
                                <div class="col-lg-2 divFromDate">
                                    <label>Month</label>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ValidationGroup="Search" Text="*" ForeColor="Red" Display="Dynamic" ControlToValidate="txtFromDate" InitialValue="0"></asp:RequiredFieldValidator>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ValidationGroup="Search" Text="*" ForeColor="Red" Display="Dynamic" ControlToValidate="txtFromDate" InitialValue=""></asp:RequiredFieldValidator>
                                    <asp:TextBox ID="txtFromDate" autocomplete="off" runat="server" CssClass="form-control txtFromDate DatePickerMonthComplete txtMonthOfPayroll" AutoCompleteType="Disabled" onpaste="return false">
                                    </asp:TextBox>
