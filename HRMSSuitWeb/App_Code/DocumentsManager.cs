...
public class DocumentsManager : Base
{
    [Serializable]
    ...
    public DocumentsManager(DOCUMENTS_TYPE DocumentsType)
    {
    ...
    public void AddDocument(Document document)
    {
        try
        {
            ...
            if (document.DocumenTypeId != 0 || document.DocumentSubTypeId != 0)
            {
    ...
    public DataTable GetDocuments(object TargetId)
    {
        try
        {
            string query =
               ...
               + " and DocumentTypeId is not null and DocumentSubTypeId is not null";
            //  );
