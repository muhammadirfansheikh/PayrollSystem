        ...
        if (IncreaseRate != null && IncreaseRate > 0) {
            if (PremiumRate != null && PremiumRate > 0) {
                ...
                if (PremiumRateGPA != null && PremiumRateGPA > 0) {
                    ...
                    service.report_GetBudgetDetailReportWithIncrease(EmployeeCode, CompanyId, PremiumRate,PremiumRateGPA, IncreaseRate,
                        PayrollMonth, onGetBudgetDetailReportWithIncrease, null, null);
                }
                else {
...
function onGetBudgetDetailReportWithIncrease(result) {
    ...
    var divTbodyGoalFund = $('.tbodybudgetwithincreaseListing').html('');
    $('#budgetwithincreaseListing').tmpl(res).appendTo(divTbodyGoalFund);
    ...
    SetReportHeader('Budget With Increase Report', 10, '');
...
function ClearReport() {
    ...
    $('.clsReportH').hide();
    $('.tbodybudgetwithincreaseListing').html('');
