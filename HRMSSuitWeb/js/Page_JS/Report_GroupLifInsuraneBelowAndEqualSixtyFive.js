...
function GetEmployee() {
    ...
    if (CompanyId > 0) {
        ...
        if (PremiumRate != null && PremiumRate > 0) {
            ...
            service.report_GroupLifeInsuranceBelowAndEqualSixtyFive(EmployeeCode, CompanyId, PremiumRate,
                PayrollMonth, onGetLifeInsuranceBelowAndEqualSixtyFive, null, null);
        }
        else {
...
function onGetLifeInsuranceBelowAndEqualSixtyFive(result) {
    ...
    var divTbodyGoalFund = $('.tbodyGLIBelowListing').html('');
    $('#GLIBelowListing').tmpl(res).appendTo(divTbodyGoalFund);
    ...
    SetReportHeader('Group Life Insurance Below And Equal To Sixty Five Report', 10, '');
