...
function GetEmployee() {
    ...
    service.report_MonthlyPfDeduction(CompanyId, Year, onGetMonthlyPfDeduction, null, null);
...
function bindReport(res) {
    ...
    $('.tbodyMonthlyPfDeduction').html('');
    SetReportHeader('Monthly PF Deduction Report', 15, '');
...
function bindReportSummary(res) {
    ...
    $('.clsDateH').html('Year : ' + $('.txtYear').val());
    $('.tableMonthlyPfDeductionSumm theadMonthlyPfDeductionSumm ').find('.clsReportNameH').html('Monthly PF Deduction Report');
