...
function GetEmployee() {
    ...
    if (CompanyId > 0) {
        ...
        if (PremiumRate != null && PremiumRate > 0) {
            ...
            service.report_GroupPersonalAccidentInsurance(EmployeeCode, CompanyId, PremiumRate,
                PayrollMonth, onGetGroupAccidentInsurance, null, null);
        }
        else {
...
function onGetGroupAccidentInsurance(result) {
    ...
    var divTbodyGoalFund = $('.tbodyGPAIListing').html('');
    $('#GPAIListing').tmpl(res).appendTo(divTbodyGoalFund);
    ...
    SetReportHeader('Group Personal Accidental Insurance Report', 10, '');
