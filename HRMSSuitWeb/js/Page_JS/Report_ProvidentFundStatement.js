...
function GetEmployee() {
    ...
    service.report_ProvidentFundStatement( CompanyId,  PayrollMonth, onGetTaxForecast, null, null);
...
function onGetTaxForecast(result) {
    ...
    var divTbodyGoalFund = $('.PFStatements').html('');
    $('#PFStatements').tmpl(res).appendTo(divTbodyGoalFund);
