...
function GetEmployee() {
    ...
    if (CompanyId > 0) {
        ...
        service.report_JV_Bonus(EmployeeCode, GroupId, CompanyId, LocationId, BusinessUnitId, DepartmentId, CostCenterId, CategoryId, DesignationId, Firstname, Lastname, PayrollMonth, IsSummary, onGetJV, null, null);
    } else {
