...
function GetEmployee() {
    ...
    if (CompanyId > 0) {
        ...
        ClearReport();
        var service = new HrmsSuiteHcmService.HcmService();
        service.Report_Bonus_Pay_Order(EmployeeCode, GroupId, CompanyId, LocationId, BusinessUnitId, DepartmentId, CostCenterId,
            CategoryId, DesignationId, Firstname, Lastname, BankId, BankMaterId, BonusId, onGetReportPayOrder, null, null);
    } else {
