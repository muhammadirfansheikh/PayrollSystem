    ...
    if (CompanyId > 0) {
        ...
        if (PremiumRate != null && PremiumRate > 0) {
            if (PremiumRateGPA != null && PremiumRateGPA > 0) {
                ...
                service.report_GetBudgetSummaryReportActual(CompanyId, PremiumRate,
                    PayrollMonth, EmployeeCode, PremiumRateGPA, GroupByValue, onGetBudgetSummaryActualDetailReport, null, null);
            }
            else {
...
function onGetBudgetSummaryActualDetailReport(result) {
    ...
    //}
    var divTbodyGoalFund = $('.tbodybudgetsummaryactualListing').html('');
    $('#budgetsummaryactualListing').tmpl(res).appendTo(divTbodyGoalFund);
    ...
    $('.ClsGrossSalaryANDOtherBenefits').each(function () {
        TotalGrossAndOtherBenefits += parseFloat($(this).text().trim());
    });
    ...
    SetReportHeader('Budget Summary Actual Report', 10, '');
...
function ClearReport() {
    ...
    $('.clsReportH').hide();
    $('.tbodybudgetsummaryactualListing').html('');
