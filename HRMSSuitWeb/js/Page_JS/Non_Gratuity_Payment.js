        ...
        if (FromDate != null) {
            if (ToDate != null) {
                ...
                if (ToDate >= FromDate) {
                    ...
                    service.Report_Gratuity(EmployeeCode, CompanyId, FromDate, ToDate, 0, onReportGratuity, null, null);
                }
                else {
...
function onReportGratuity(result) {
    ...
    var divTbodyGoalFund = $('.tbodyGListing').html('');
    $('#GListing').tmpl(res).appendTo(divTbodyGoalFund);
    ...
    SetReportHeader('Gratuity Report', 10, Para2);
